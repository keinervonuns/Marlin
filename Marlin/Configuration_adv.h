...
#define HOMING_BUMP_MM      { 0, 0 }          // (linear=mm, rotational=°) For sensorless, keep zero to avoid re-trigger latch
#define HOMING_BUMP_DIVISOR { 2, 2 }          // Re-Bump Speed Divisor (Divides the Homing Feedrate)

#define HOMING_BACKOFF_POST_MM { 20, 20 }     // (linear=mm, rotational=°) Backoff from endstops after homing
...
//#define DISABLE_REDUCED_ACCURACY_WARNING
  ...
  #define MANUAL_FEEDRATE { 50*60, 50*60 }             // (mm/min) Feedrates for manual moves along X, Y from panel
 ...
 */
#define STARTUP_COMMANDS "M106 P0 S255\nG1 F18000\nM810 M106 P0 S0|M226 P32 S1|M226 P32 S0|G4 P700\nM811 M106 P0 S255\nM812 M280 P0 S10\nM813 M280 P0 S93\nM812"
